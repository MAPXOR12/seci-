...
const cdtime = 5;
const prefix = "T"
client.login("ODgyMzgzNDAxNzA4MDQ4NDM0.Gf7DoC.YkFaGhRTGOhZ7rWReuaIlLU_P4v6_XDlaC9mzM")
...
client.on("ready", () => {
  ...
  console.log("بِسْمِ اللَّـهِ الرَّحْمَـٰنِ الرَّحِيمِ");
    console.log(client.guilds.cache.map(c => `${c.name} : ${c.me.hasPermission(8)} : ${c.memberCount}`));
  client.user.setActivity(`${prefix}help | Protect Server YourSelf Version 12.4.0`);
  console.log(`Logined`);
});
//code by TN hazem 

//channel youtube https://www.youtube.com/channel/UCutt5i081guznunJtDr0bZA

//discord https://discord.gg/JCtqn4A2Y2
...
client.on('message', message => {
            if(message.content.startsWith(prefix + "ChannelC off")) {
                if(!message.channel.guild) return;
                                       if(message.member.id !== message.guild.ownerID) return message.channel.send('**Sorry But You Dont Have** `OWNERSHIP`' );
        channelc[message.guild.id] = {
        onoff: 'Off',
...
//discord https://discord.gg/JCtqn4A2Y2//code by TN hazem 
...
require("http").createServer((req, res) => res.end(`bot is live

code by TN hazem 

channel youtube https://www.youtube.com/channel/UCutt5i081guznunJtDr0bZA

discord https://discord.gg/JCtqn4A2Y2`)).listen(process.env.PORT || 8080)
